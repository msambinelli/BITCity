...
\begin{figure}[ht!]
  ...
  \subfigure[Árvores crescendo, deslocamento de carros e outros detalhes \label{fig1}]{
    \includegraphics[scale=0.60]{figs/map1_1.png}
%  \caption{Modelo \ref{short-one} renderizado \label{fig1}}
  }
%\end{figure}
%\begin{figure}[ht!]
%  \centering
  \subfigure[Chovendo no mundo \label{fig2}]{
    \includegraphics[scale=0.60]{figs/map1_2.png}
  %\caption{Chovendo no mundo \label{fig2}}
  }
